...
public class SpringIbatisContactDAOTest extends IbatisDAOTestCase {

	@SuppressWarnings("unused")
	private static final Logger logger = 
		LoggerFactory.getLogger(SpringIbatisContactDAOTest.class);
	...
	public void setUp() throws Exception {
		...
		contactDao = (ContactDAO) ctx.getBean("contactDaoWithTemplate");
		studentDao = (StudentDAO) ctx.getBean("studentDaoWithTemplate");
